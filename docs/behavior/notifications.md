...
Living contract for customer notifications: the behavior every intervention must honor and the givens none can trade away. Edited in place under operator confirmation; git history is the archive.
...
- Every organization has at least one owner; hardening member management is out of scope here.

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 429524e8cd58e97d7b06f63494c2a989)
// Runtime types generated with workerd@1.20260714.1 2026-04-08 nodejs_compat
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	GITHUB_CLIENT_ID: "Ov23lieleOx1ivZtTJvO";
	NOTIFICATION_ACTIVATION_TS: "2099-01-01T00:00:00Z";
	BETTER_AUTH_SECRETS: string;
	BETTER_AUTH_API_KEY: string;
	GITHUB_CLIENT_SECRET: string;
	STRIPE_SECRET_KEY: string;
	PHASE_APPROVAL_WORKFLOW: Workflow<Parameters<import("./src/worker").PhaseApprovalWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_CLIENT_ID" | "NOTIFICATION_ACTIVATION_TS" | "BETTER_AUTH_SECRETS" | "BETTER_AUTH_API_KEY" | "GITHUB_CLIENT_SECRET" | "STRIPE_SECRET_KEY">> {}
}
